...
def __cpp_sim_matrix_l_generation_routine__(sim_matrix_path, mscmodel, msc2ix, secondary_codes_weight, docid2seccodes):
    ...
    r = cpp_wrapper.aggregate_simmatrix(sim_matrix_path, dstmatrixpath, msc2wids_list, method=similarity_aggregation_method_l)
    print "RESULT=",r
...
if __name__ == "__main__":
    ...
    try:
        ...
        print "[build_msc_tree] Argument expected: similarity-matrix-path"
        sys.exit(-1)
    try:
        method = argv[3]
