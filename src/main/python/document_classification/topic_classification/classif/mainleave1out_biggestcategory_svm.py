...
from stattools import most_common_categ
...
if __name__ == '__main__':
    ...
    most_common_categ, max_cnt = most_common_categ.extract_most_common_categ(frecords)
    print "Most common category is:", most_common_categ, " with ", max_cnt, " occurences."
    
    loo = LeaveOneOut(lambda samples: SvmSingleTagWordsClassifier(most_common_categ, samples), frecords, lambda x: [int(most_common_categ in x[1])])
