...
class FractionKnnJrsTrainedSemiEnsembled(object):
    '''
    ...
    def __init__(self, distances, train_labels, k_list, list_of_all_labels, min_weight):
        '''
        ...
        self.classifiers = []
        for k in k_list:
            self.classifiers.append(FractionKnnJrsTrained(distances, train_labels, k, list_of_all_labels))
...
if __name__ == "__main__":
    ...
    mlknn_jrs = FractionKnnJrsTrainedSemiEnsembled(distances, labels, [1, 2, 3], list_of_all_labels, 0.5)
