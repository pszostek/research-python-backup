...
LOAD_ROWS_FROM_FILE = 6000 #ile wierszy wczytac z pliku
CAST_METHOD = 'float' #do jakiego formatu rzutujemy liczby z pliku

REDUCE_DATA_TO_SIZE = 10000 #do ilu probek obciac dane

DEV_FRACTION = 0.4 #ulamek danych w zbiorze DEV
TRAINING_FRACTION = 0.4 #ulamek danych w zbiorze TRAIN

ADJUSTING = True #czy wykonywac procedure filtrowania zbioru train
ADJ_DEFAULT_REMOVE = True #czy domyslnym krokiem czy filtrowaniu jest usuwanie
