...
if __name__ == "__main__":
    print "The tree  (345-pattern-tree from NUMDAM/CEDRAM data) is compared to random data..."
    ...
    print "Comparing to random trees..."
    results = {} #{index-name: list of results}
    start = time.clock()
    for i in xrange(NUM_TRIES):
        print "[",(time.clock()-start),"s]",i,"out of",NUM_TRIES
