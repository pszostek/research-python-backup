...
#for mlknn
from mlbaselines.weightedrandomlabel_classifier import WeightedRandomLabelClassifier

def PRINTER(x):
    logging.info('[main_train_weighted_random][main]: '+str(x))
...
if __name__ == '__main__':
    ...
    random_classif = WeightedRandomLabelClassifier(train_generator, get_labels_of_record, classify_oracle)
